...
export const getTeachers = async () => {
    try {
        const res = await axios.get(process.env.REACT_APP_API + "/facultys/page/1", {
            headers: {
...
export const getTotalFaculty = async () => {
    try {
        const res = await axios.get(process.env.REACT_APP_API + "/facultys/count", {
            headers: {
              token: "Bearer " + JSON.parse(localStorage.getItem("user")).accessToken,
            }
          });
...
export const getFacultyByPage = async (page) => {
    try {
        const res = await axios.get(process.env.REACT_APP_API + "/facultys/page/" + page, {
            headers: {
              token: "Bearer " + JSON.parse(localStorage.getItem("user")).accessToken,
            }
          });
...
export const getTotalFacultyByDepartment = async (department) => {
    try {
        const res = await axios.get(process.env.REACT_APP_API + "/facultys/count/" + department, {
            headers: {
              token: "Bearer " + JSON.parse(localStorage.getItem("user")).accessToken,
            }
          });
...
export const getFacultyByDepartmentAndPage = async (department, page) => {
    try {
        const res = await axios.get(process.env.REACT_APP_API + "/facultys/page/" + page + "/" + department, {
            headers: {
              token: "Bearer " + JSON.parse(localStorage.getItem("user")).accessToken,
            }
          });
...
export const getTeacherVotes = async () => {
    try {
        const res = await axios.get(process.env.REACT_APP_API + "/facultys/updownvotescount", {
            headers: {
              token: "Bearer " + JSON.parse(localStorage.getItem("user")).accessToken,
            }
          });
